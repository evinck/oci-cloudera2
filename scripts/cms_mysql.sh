...
sed -e 's/NEED_AGENT_VALIDATION true/NEED_AGENT_VALIDATION false/g' /var/lib/cloudera-scm-server/certmanager/cm_init.txt.ori > /var/lib/cloudera-scm-server/certmanager/cm_init.txt.tmp
